...
Developed by Adam using concepts of file handling and oops concepts in c++
...
ABOUT US::
......
Adam is a software enthusiast | Ada's Dad, a data scientist passionate about the convergence of technology
and innoviation within a digitized economy.

CONTACT US::
......
E-mail: iyalex250@gmail.com
Phone: (+250)788288712
Linkedin: @iyalex250
X: @iyalex250
Note: Run a program in full Screen.
*/
#include<iostream>
#include<fstream>
#include<conio.h>
...
cout<<"\t\t\t\t\t@@|                                  WELCOME TO                                           |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                           AD-HOST TECHNOLOGIES SHOP                                   |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|              Copyrights 2024 All Rights Reserved by @iyalex Inc.                      |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                                                                                       |@@\n";
cout<<"\t\t\t\t\t@@|                        DEVELOPED BY AD-HOST TECHNOLOGIES                              |@@\n";
cout<<"\t\t\t\t\t@@|_______________________________________________________________________________________|@@\n";
cout<<"\t\t\t\t\t@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\n\n\n\t\t\t\t\t";
...
++i;
 ...
 password[i]='\0';
 getch();
 if(strcmp(username,"Tango")==0 && strcmp(password,"adhost")==0)
  {
   f=0;
   goto I;
  }
 ...
 do
 {
     I:
	   ...
	   cout<<setw(62)<<"BY AD-HOST TECH"<<endl;
